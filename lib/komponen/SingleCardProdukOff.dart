...
class SingleCardProdukOff extends StatelessWidget {
  final Produk produk;
  final String nama;

  const SingleCardProdukOff({Key key, this.produk, this.nama})
      : super(key: key);
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(produk.picture), fit: BoxFit.cover),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: CircleAvatar(
                      ...
                      radius: 40.0,
                      backgroundImage: AssetImage(produk.heropicture),
                    ),
                  ),
                ),
              ]))),
